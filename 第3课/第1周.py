...
【5】贝叶斯误差与人类水平误差	
	贝叶斯最优误差，一般认为是理论上可能达到的最优误差，就是说没有任何办法设计出一个x到y的函数，让它能够超过一定的准确度。
	贝叶斯最优误差就是从x到y映射的理论最优函数，永远不会被超越。
	...
	人类水平误差到贝叶斯误差估计值的差距告诉你可避免偏差问题有多大，有多严重；训练误差和开发误差之间的差值告诉你方差上的问题
	有多大，你的算法是否能够从训练集泛化推广到开发集。
